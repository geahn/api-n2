<?php
    ...
    class Transaction {
        ...
        public static function select($user_id) {
            ...
            $result = pg_query($bdcon, "select t.* from daniel_geahn.transactions t inner join daniel_geahn.user_releases ur on t.id = ur.transaction_id where ur.created_at between '2022-05-28' and '2022-05-28 23:59:59.999' and ur.user_id = ".$user_id);
