<?php
    ...
    class Transaction {
        ...
        public static function select($user_id) {
            ...
            return "select t.*, ur.value value_u, ur.created_at updated_u from daniel_geahn.transactions t inner join daniel_geahn.user_releases ur on ur.transaction_id = t.id and ur.id = (select max(ur2.id) from daniel_geahn.user_releases ur2 where ur2.user_id = '1' and ur2.transaction_id = t.id)";
