<?php
    ...
    class Transaction {
        ...
        public static function select($user_id) {
            ...
            $result = pg_query($bdcon, "SELECT * FROM daniel_geahn.transactions INNER JOIN daniel_geahn.user_releases ON daniel_geahn.transactions.id = daniel_geahn.user_releases.user_id");
